    ...
    <form action="newuserregister" method="post">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input type="email" name="email" id="email" class="form-control" placeholder="Email*" required minlength="6">
            </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="address" id="address" class="form-control" placeholder="Enter Your Address" rows="3"></textarea>
        </div>

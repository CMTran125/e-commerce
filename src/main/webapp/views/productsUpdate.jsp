			...
			<div class="row">
				...
				<div class="form-group">
					...
					<div class="form-group">
					    ...
					    <input type="text" class="form-control border border-success" required name="productImage" value="${ product.image }" placeholder="Enter Image URL" oninput="loadImageFromLink(event)">
					</div>
					<img id="imgPreview" src="${ product.image }" alt="Image Preview" style="max-width: 200px; margin-top: 10px;"/>
					
					<script type="text/javascript">
					    function loadImageFromLink(event) {
